...
sample_paths_table = ctUtil.paths_to_table(path,".wav",instrument_name_prefix)
...
if perform_mapping then
	...
	sample_tokens_table = ctUtil.tokens_to_table(sample_paths_table,token_separator,reverse_token_order)
